      ...
      lightbox.pswp.ui.registerElement({
        ...
        onClick: (event, el) => {
          ...
          const name = slide.data.altText
            ? slide.data.altText.replace(/[^a-z0-9]/gi, "_").toLowerCase()
            : "imagen";
...
// Al final de tu archivo src/js/photoswipe-init.js

// Garantiza que se ejecute cuando el árbol DOM esté completamente cargado
